                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-Nama"  value="<?php  echo $this->set_field_value('Nama',""); ?>" type="text" placeholder="Enter Nama"  required="" name="Nama"  data-url="api/json/login_Nama_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
